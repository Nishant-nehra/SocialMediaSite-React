...
class UserProfile extends Component {
  ...
  handleAddFriendClick = async () => {
    ...
    //we have used async url calling here->use await keyword
    //generally we do via actions and don't need to do this
    //await is used to wait till the action is complete then proceed to next action
  ...
  render() {
    // here localhost3000/:varName used in app.js gives access to stuff written here as props to the component via variable name
    const {
      match: { params },
      profile,
    } = this.props;
    //we have renamed match.params as params for better readability in above lines
